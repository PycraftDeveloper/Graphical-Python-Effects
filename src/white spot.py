...
class Point:
    ...
    def render(self):
        ...
        v_y = (1+generatekey(now_time, 0, self.y_seed))*5
...
seed = getseed(random.randint(0, 9999))
...
while True:
    ...
    r = k*(1+generatekey(now_time/10, 0, rseed))
    g = k*(1+generatekey(now_time/10, 0, gseed))
    b = k*(1+generatekey(now_time/10, 0, bseed))
    ...
    Surface2.set_alpha((1+generatekey(now_time/10, 0, seed))*50) # 10
