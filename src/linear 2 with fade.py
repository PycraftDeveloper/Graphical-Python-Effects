...
while True:
    ...
    color = [seed.generate_2D_perlin_noise(0, now_time/10, new_range=[0, 255]), seed.generate_2D_perlin_noise(0, -now_time/10, new_range=[0, 255]), seed.generate_2D_perlin_noise(now_time/10, 0, new_range=[0, 255])]

    line_points = []
    for x in range(center[0], 0, -1):
        y_displacement = seed.generate_2D_perlin_noise(x/100, now_time/10, new_range=[-center[1], center[1]])
